/**
 * SGYT Engine V16 - BashUpload Edition
 * User: SlayerGamerYT
...
async function triggerAction() {
    ...
    try {
        ...
        if (response.status === 204) {
            log("Backend processing. Securely uploading to BashUpload...", "log-success");
        ...
        try {
            ...
            if (run && run.status === 'completed') {
                ...
                if (run.conclusion === 'success') {
                    log("Engine Success! Scraping secure link...", "log-info");
...
async function fetchLinksFromLogs(token, runId) {
    try {
        ...
        // Match the plain text link generated by BashUpload
        const linkMatch = logText.match(/DOWNLOAD_LINK: (https:\/\/bashupload\.com\/\S+)/);
